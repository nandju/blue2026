...
import Academy from "@/public/ong_blue/images/illustrations/page-landing/blue_training_1.png";
		...
		<AnimatePresence>
			{activeIndex === 0 && !dismissed && (
				<motion.div
					...
					<span className="text-[10px] uppercase tracking-[4px] text-[#0D6EBB] font-medium">
						Défiler
					</span>
					<motion.div
						className="w-[1.5px] h-14 bg-[#0D6EBB] origin-top"
						animate={{
							scaleY: [0, 1, 1],
							opacity: [0, 1, 0],
						}}
			...
			<Section>
				<div className="mx-auto w-[82%] max-w-screen-2xl grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden">
					<motion.div
						...
						<motion.h3
							className="uppercase text-xl mb-3 font-normal text tracking-[.5rem] text-[#0DBD9F]"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.2,
						...
						<motion.h1
							className="text-[#0D6EBB] text-4xl md:text-6xl lg:text-6xl 2xl:text-8xl font-bold my-2 md:my-5"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.3,
							...
							Ensemble Contre la Pollution Plastique
						</motion.h1>
						<motion.p
							className="title text-md 2xl:text-xl mt-4 tracking-wider text-gray-600 leading-[1.7rem]"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.4,
							...
							BLUE est une organisation non gouvernementale fondée en janvier 2022 à Abidjan, dédiée à la lutte contre la pollution plastique. Nous formons des ambassadeurs environnementaux et mobilisons les communautés pour un avenir durable.
						</motion.p>
						<motion.div
							...
							<Button variation="secondary">
								<a href="#contact">Devenir Bénévole</a>
							</Button>
						</motion.div>
					</motion.div>
					<motion.div
			...
			<Section>
				<div className="relative md:h-screen w-screen gap-4 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
						<motion.h1
							className="bg-white lg:bg-transparent bg-opacity-50 px-3 md-px-0 text-[#0D6EBB] text-5xl md:text-8xl font-bold"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.1,
						...
						<Hr />
						<motion.p
							className="title  text-xl mt-4 tracking-wider text-gray-600 leading-[1.7rem] mb-5"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.2,
				...
				<div className="relative md:h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
						...
						<motion.p
							...
							Apprenez, certifiez-vous et{" "}
							<span className="bg-transparent md:bg-gray-100 bg-opacity-50 xl:bg-transparent">
								devenez ambassadeur de l&apos;environnement.
							</span>
						</motion.p>
						<motion.div
							initial={{ y: 40, opacity: 0 }}
							...
							<Button variation="primary">
								<Link href="/academy">Découvrir l&apos;Academy</Link>
							</Button>
						</motion.div>
					</div>
				</div>
			...
			<Section>
				<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
						<motion.h1
							className="bg-white lg:bg-transparent bg-opacity-50 px-3 md-px-0 text-[#0D6EBB] text-5xl md:text-8xl font-bold mb-3"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.1,
						...
						<Hr />
						<motion.p
							className="title text-xl mt-4 tracking-wider text-gray-600 leading-[1.7rem] md:mb-5"
							initial={{ x: -100, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
							transition={{
								delay: 0.2,
						...
						<motion.p
							...
							<a href="mailto:blue@bluemakers.net?subject=Contact&body=Bonjour BLUE,">
								blue@bluemakers.net
							</a>
						</motion.p>
						{/* icons */}
						<div className="flex justify-center items-center space-x-4">
							<motion.a
								href="mailto:blue@bluemakers.net?subject=Contact&body=Bonjour BLUE,"
								aria-label="Send email"
								className="flex justify-center items-center bg-[#0D6EBB] w-14 h-14 rounded-full text-white hover:bg-[#0DBD9F] transition-all ease-in-out duration-300"
								initial={{ y: 40, opacity: 0 }}
								whileInView={{ y: 0, opacity: 1 }}
								transition={{
									y: { delay: 0.1 },
							...
							<motion.a
								href="https://www.facebook.com/bluemakers"
								target="_blank"
							...
							<motion.a
								href="https://www.instagram.com/bluemakers"
								target="_blank"
								rel="noopener noreferrer"
							...
							<motion.a
								href="https://www.linkedin.com/company/bluemakers"
								target="_blank"
								rel="noopener noreferrer"
